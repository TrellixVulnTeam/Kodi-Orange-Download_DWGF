...
player_user_agent = 'mediaPlayerhttp/7.15 (Linux;Android 5.1) ExoPlayerLib/2.6.1'
...
def list_channels(cat_id=None):
    ...
    for c in ch['msg']['channels']:
        if c['cat_id'] == cat_id:
            image = "http://uktvnow.net/uktvnow8/{0}|User-Agent={1}".format(quote(c.get('img'), '/'), quote(user_agent))
...
def play(ch_id):
    # 178.132.6.233 109.236.83.83 178.132.5.16 193.70.111.192 137.74.200.60 149.202.197.108
    key = b"10912895"
